...
//     */
    ...
    Map mapPhase3 = mapLoaderPart3.buildMapB("../MapFiles/file");           //ERROR HERE
    ...
    ResourceMarket *resMarketPtr = reinterpret_cast<ResourceMarket *>(&resMarket);
    ...
    //gamePhase: 1
    for ( int i = 0 ; i < playersPhase3.size() ; i++ )
        playersPhase3.at(i).buyCities( mapPhase3Ptr, 1 );
